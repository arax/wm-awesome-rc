...
for s = 1, screen.count() do
    ...
    -- Create screen ID widget
    screen_id = wibox.widget.textbox()
    screen_id:set_text("Screen " .. s)
    ...
    function(widget, args)
      if args[2] < 20 and args[2] >= 10 and args[1] == "-" then
        naughty.notify({ preset = naughty.config.presets.low,
                         ...
                         timeout = 10 })
      elseif args[2] < 10 and args[2] >= 5 and args[1] == "-" then
        naughty.notify({ preset = naughty.config.presets.normal,
                         text = "Hey! Go and get me a power supply, now!",
                         title = "PM Notification",
                         timeout = 20,
                         bg = '#FFA500',
                         fg = '#000000' })
    ...
    kbdcfg.layout = { "us", "sk", "cz" }
    kbdcfg.current = 1  -- us is our default layout
    kbdcfg.widget = wibox.widget.textbox()
    local t_active = " " .. kbdcfg.layout[kbdcfg.current] .. " "
    kbdcfg.widget:set_text(t_active)
    ...
    vicious.register(fswidget, vicious.widgets.fs, "/ ${/ avail_gb}GB || /home ${/home avail_gb}GB")
